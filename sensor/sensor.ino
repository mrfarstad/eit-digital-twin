...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(temperature,humidity,pressure,altitude, eco2, tvoc));
}
...
String SendHTML(float temperature,float humidity,float pressure,float altitude,float eco2, float tvoc){
  ...
  ptr +=".co2 .reading{color: #f54281;}";
  ptr +=".tvoc .reading{color: #4842f5;}";
  ...
  ptr +="</div>";
  ptr +="<div class='data tvoc'>";
  ptr +="<div class='side-by-side icon'>";
  ptr +="</div>";
  ptr +="<div class='side-by-side text'>TVOC</div>";
  ptr +="<div class='side-by-side reading'>";
  ptr +=(int)tvoc;
  ptr +="<span class='superscript'>ppb</span></div>";
  ptr +="</div>";
  ptr +="</div>";
  ptr +="</body>";
  ptr +="</html>";
